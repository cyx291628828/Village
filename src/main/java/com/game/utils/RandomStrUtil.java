...
//        System.out.println(randomStrId());
        loginWhiteList(11, 30, 1, 2);
    }

    public static void loginWhiteList(int serverId, int count, int idx1, int idx2) {
        String prefix = randomStr(8);
        String userNames = "sadd s.sgame.lwlist." + serverId + " ";
     ...
     * @return
     */
    public final static String randomStrId() {
        return (randomStr(7) + (System.currentTimeMillis() / 1000 + "").substring(7));
    }
     ...
     * </pre>
     */
    public final static void testRandomId() {
        ...
        System.out.println("总共重复数：" + (size - set.size()) + ",耗时:" + ct + "ms");
